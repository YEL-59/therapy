...
function Blog() {
	return (
		<div>
			<div className="container mx-auto flex lg:flex-row flex-col  justify-between items-center gap-9 mt-20">

				<div>
					<div >
						<div class=" w-full rounded-lg shadow-lg bg-white mb-6">
							<a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
								<img class="rounded-t-lg" src={BlogImg} alt="" />
							</a>
							<div class="p-6 bg-[#f4f8f9]">
								<h5 class=" text-gray-900 text-2xl font-semibold mb-2">How to Build-An On-Demand-Liquor Delivery App?</h5>
				...
				<div>
					...
					<div className='w-full bg-[#f4f8f9] p-5 '>
						<div className='flex flex-col lg:flex-row gap-4 mb-5'>
							<div>
								<img src={BlogImg} className='h-auto w-full lg:h-20' alt="" />
							</div>
							<div>
